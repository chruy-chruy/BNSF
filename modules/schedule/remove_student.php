...
$track = $_GET['track'];
    ...
    if (mysqli_query($conn, $sql2)) {
        header("location:schedule.php?id=$id&message=Success! Student details have been removed successfully.&grade=$grade&track=$track&section=$section&quarter=$quarter&sy=$sy");
    } else {
