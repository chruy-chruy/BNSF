...
<div class="content" id="content">
  <h1>Track Module</h1>
  <p>Manage the list of Track and Strand here.</p>
  ...
  <div id="scheduleSection" class="d-flex justify-content-center align-items-center" style="height: 50vh;">
    <div class="text-center">
      ...
      <div class="d-flex justify-content-center gap-4">
        <a href="strand.php?track=TVL" class="btn btn-tvl btn-box">TVL</a>
        <a href="strand.php?track=Academic" class="btn btn-academic btn-box">Academic</a>
      </div>
    </div>
  </div>
</div>
